...
% Header override for index
\fancypagestyle{index}[fancy]{
...
\begin{document}
	...
	\titlepage % Output the title page
		...
		{ % Title(s) and author(s)
			...
			{\huge\color{ocre}Honors in Linear and Abstract Algebra I} % Book title

			\vspace{2cm} % Vertical whitespace

			Lecture Notes for\par
			MATH 2131
...
%			\vfill
			...
			% {\huge\bfseries Stupid--Benz} % Author name
		}
	...
	\noindent{\Large\bfseries\sffamily Preface}

	\vspace{8pt}

	\noindent This lecture notes was written by a student in the course MATH 2131 -- Honors in Linear and Abstract Algebra by Professor Meng Guowu\nocite{mgw} in HKUST in 2025--26 Fall.

	\noindent All diagrams in this lecture notes are written in \LaTeX\ TikZ code.

	\noindent These notes are with reference to textbooks \citetitle{Friedberg2018-su} by \citeauthor{Friedberg2018-su}, \citetitle{artin_2018} by \citeauthor{artin_2018} and \citetitle{Fraleigh2002-ck} by \citeauthor{Fraleigh2002-ck}.
	...
	\addcontentsline{toc}{section}{\textcolor{ocre}{List of Symbols}}
	...
	\begin{appendices}
		...
		\markboth{\sffamily\normalsize\bfseries Bibliography}{\sffamily\normalsize Bibliography} % Set the page headers to display a Bibliography chapter name
